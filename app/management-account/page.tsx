    ...
    <div className="p-6 md:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => router.push("/buku-ekspedisi")}
            className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-600 text-white rounded-lg shadow hover:bg-slate-700 transition-colors"
          >
            <ArrowLeft size={18} />
            Kembali
          </button>
